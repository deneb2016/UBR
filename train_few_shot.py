...
def parse_args():
    ...
    # set few shot adaptation parameter
    parser.add_argument('--pretrained_model', type=str, default="UBR_RES_FC3_500003_12")
...
def train():
    ...
    train_dataset = TDetDataset(['voc07_few_shot_' + args.K], training=True, multi_scale=args.multiscale, rotation=args.rotation, pd=args.pd, warping=args.warping)
    #val_dataset = TDetDataset(['coco60_val'], training=False)
    tval_dataset = TDetDataset(['voc07_test'], training=False)
    ...
    if args.net == 'UBR_VGG':
        ...
        UBR = UBR_RES(None, 1, not args.fc)
    elif args.net == 'UBR_RES_FC2':
        UBR = UBR_RES_FC2(None, 1)
    elif args.net == 'UBR_RES_FC3':
        UBR = UBR_RES_FC3(None, 1)
    ...
    load_name = '../repo/ubr/%s.pth' % args.pretrained_model
