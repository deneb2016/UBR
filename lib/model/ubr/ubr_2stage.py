...
class UBR_Objectness(nn.Module):
    def __init__(self, base_model_path):
        super(UBR_Objectness, self).__init__()
    ...
    def _init_modules(self):
        ...
        self.object_pred_layer = nn.Linear(4096, 1)
    ...
    def _init_weights(self):
        ...
        normal_init(self.object_pred_layer, 0, 0.001, False)
    ...
    def forward(self, im_data, rois):
        ...
        object_pred = self.object_pred_layer(pooled_feat)

        object_pred = F.sigmoid(object_pred)
        return object_pred
