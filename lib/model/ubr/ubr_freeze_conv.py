...
class UBR_VGG_FREEZE_CONV(nn.Module):
    def __init__(self, base_model_path=None, pretrained_fc=True, freeze_level=5):
        super(UBR_VGG_FREEZE_CONV, self).__init__()
    ...
    def _init_modules(self):
        ...
        for layer in range(self.freeze_upto):
