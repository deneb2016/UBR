...
# --------------------------------------------------------
from lib.voc.imdb import imdb as IMDB
import os
...
import uuid
import pickle
from lib import voc as voc
from lib.voc.voc_eval import voc_eval as voc_eval
...
class pascal_voc(IMDB):
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(voc.ROOT_DIR, 'data', 'VOCdevkit' + self._year)
    ...
    def gt_roidb(self):
        ...
        if os.path.exists(cache_file):
            ...
            print ('{} gt roidb loaded from {}' % (self.name, cache_file))
            return roidb
    ...
    def selective_search_roidb(self):
        ...
        if os.path.exists(cache_file):
            with open(cache_file, 'rb') as fid:
                roidb = pickle.load(fid)
            print('{} ss roidb loaded from {}'% (self.name, cache_file))
            return roidb
        ...
        print ('wrote ss roidb to {}'%cache_file)
